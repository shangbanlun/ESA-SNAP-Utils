...
def main():
    ...
    input_folder_name = 'Asm_Cal_Deb_Mat_ML'
    output_folder_name = 'TC_Subset'


    # * get the sequential operator.
    graph = Sequential(
        R.Geometric.TerrainCorrection(),
        Raster.Subset(geo_region=((31.9049, 121.1212), (31.3880, 121.9957)))
    )
